...
create table public.activities (
  ...
  -- Ensure one activity per date/time/type per user (flexible constraint)
  constraint unique_activity_per_datetime unique(user_id, date, activity_type, coalesce(time, '00:00'::time))
);
