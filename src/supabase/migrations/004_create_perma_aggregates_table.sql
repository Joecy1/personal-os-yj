...
create table public.perma_aggregates (
...
create index perma_aggregates_user_id_idx on public.perma_aggregates(user_id);
create index perma_aggregates_date_idx on public.perma_aggregates(date);
create index perma_aggregates_user_date_idx on public.perma_aggregates(user_id, date);
create index perma_aggregates_window_type_idx on public.perma_aggregates(window_type);
...
create policy "Users cannot directly modify aggregates"
  on public.perma_aggregates for insert, update, delete
  with check (false);
